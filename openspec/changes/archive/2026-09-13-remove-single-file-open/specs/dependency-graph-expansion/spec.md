...
Unit referenciada como nó folha. O `scope` informado SHALL ser aplicado à
extração do `uses` de toda unidade visitada durante a expansão — a Root
Unit e cada Project Unit alcançada transitivamente — e não apenas à Root
Unit.
