...
- **WHEN** o usuário abre um arquivo `.pas` e depois maximiza a janela do
  app
- **THEN** o grafo renderizado preenche toda a área visível da janela,
  sem sobras de espaço em branco ao redor do container
...
renderizado, o sistema SHALL ajustar o tamanho da área de renderização
do grafo para preencher o novo espaço disponível, sem exigir reabrir o
arquivo ou recarregar a janela manualmente.
...
- **THEN** a área de renderização do grafo se redimensiona
  automaticamente para preencher a nova área disponível, sem
  necessidade de reabrir o arquivo
