# external-unit-classification

## Purpose

Classificar as dependências diretas de uma unidade (cláusula `uses`) como
Project Unit ou External Unit, comparando contra a lista de Project Units
de um Projeto (`.dpr`), para permitir distinção visual dessas unidades no
